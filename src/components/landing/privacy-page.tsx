      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-8">
            <FadeIn>
              <div>
                <h2 className="text-xl font-bold text-gray-900 mb-3">1. Collecte des donn&eacute;es</h2>
            ...
            <FadeIn>
              <div>
                <h2 className="text-xl font-bold text-gray-900 mb-3">2. Utilisation des donn&eacute;es</h2>
                <p className="text-gray-600 leading-relaxed">
            ...
            <FadeIn>
              <div>
                <h2 className="text-xl font-bold text-gray-900 mb-3">3. S&eacute;curit&eacute; des donn&eacute;es</h2>
                <p className="text-gray-600 leading-relaxed">
